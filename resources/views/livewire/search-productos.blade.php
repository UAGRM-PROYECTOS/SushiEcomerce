            ...
            <div class="md:grid md:grid-cols-5 gap-5">
                <div class="mb-5">
                    ...
                    <input
                        ...
                        wire:model="termino"
                        type="text"
                        placeholder="Buscar por término: ej. Salmon/Supreme/Grande.."
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold">{{__('Tamano')}}</label>
                ...
                <div class="mb-5">
                    <label class="block mb-1 text-sm text-gray-700 uppercase font-bold">{{__('Descuento')}}</label>
                    <select class="border-gray-300 p-2 w-full rounded-lg" wire:model="descuento" >
                        <option hidden selected>- SELECCIONE -</option>
                        @foreach ($descuentos as $descuento)
                        <option value="{{$descuento->id}}">{{$descuento->descuento*100 . "%"}}</option>
                        @endforeach
                    </select>
                </div>
